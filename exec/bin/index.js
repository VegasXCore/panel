...
program
    .version("0.1.0-beta6")
    .description("Command Line Interface for the VegasXCore Panel");
...
program
    ...
    .action(async () => {
        ...
        try {
            const imagesIndexResponse = await axios.get('https://raw.githubusercontent.com/VegasXCore/images_v2/refs/heads/seed/0.1.0-beta2.json');
...
program
    ...
    .action(async () => {
        ...
        async function main() {
            log.init('create a new *admin* user for the VegasXCore panel:')
